{ pkgs, config, ... }:
{
  persist.dir = [ ".config/YouTube Music" ];
  home = {
    packages = with pkgs; [
      youtube-music
    ];

    file.".config/YouTube Music/theme/stylix.css".text =
      let
      ...
      /* css */ ''
        ...
        /*===================Start of custom variables==============================*/
              ...
              --cust-ytmusic-play-nav-color: #${base00};
              --cust-ytmusic-dark-background: #${base00}ee;
              --cust-ytmusic-dark-foreground: #${base00}ee;

              --cust-ytmusic-light-text-1: #${base0F}e3;
              --cust-ytmusic-light-2: {base00};
              --cust-ytmusic-light-3: #${base0A};
              --cust-ytmusic-light-4: #${base05};
              --cust-ytmusic-light-5: #${base0D};

              --cust-ytmusic-medium-1: #${base0F}9c;
              --cust-ytmusic-medium-2: #${base0D};
              --cust-ytmusic-medium-3: #${base0F};
              --cust-ytmusic-medium-4: #${base0C};
              --cust-ytmusic-medium-5: #${base0F}f2;

              --cust-ytmusic-subscribe-color: #${base0F};
              --cust-ytmusic-nowplaying-color: #${base0F};
              --cust-ytmusic-playbutton-color:#${base0F};
              --cust-ytmusic-tertiary-nav-button-color: #${base0F};

              --cust-ytmusic-main-text-1: #${base0F};
              --cust-ytmusic-header-text-1: #${base0F};
              --cust-ytmusic-header-text-2: #${base0E};
        ...
        .cet-titlebar .cet-controls-container .cet-icon {
            display: none;
        }
